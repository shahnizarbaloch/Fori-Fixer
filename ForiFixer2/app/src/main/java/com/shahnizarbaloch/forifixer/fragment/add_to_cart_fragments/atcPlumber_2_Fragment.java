...
public class atcPlumber_2_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Motor Installation/Replacement","1000"));
        arrayList.add(new AddToCart("Motor Machine Installation/Replacement with Piping","Rs 1500 plus, Rs 25 per sq/ft","1500"));
        arrayList.add(new AddToCart("Water Tank Cleaning","Starting From 1200" +
                "Actual Amount will be quoted on survey","1200"));
