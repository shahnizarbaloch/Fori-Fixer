...
public class atcPlumber_3_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Airlock","1500"));
        arrayList.add(new AddToCart("Fiber or PVC Tank Installation without Piping","2500"));
        arrayList.add(new AddToCart("Kitchen Gas Leak","1000"));
        arrayList.add(new AddToCart("Mixer Tap Repair / Replacement","700"));
        arrayList.add(new AddToCart("Pressure in taps","1000"));
        arrayList.add(new AddToCart("Single Small tap replacement","600"));
        arrayList.add(new AddToCart("Sink/Basin replacement/installation without point","1000"));
        arrayList.add(new AddToCart("Sink Spindle Change","500"));
        arrayList.add(new AddToCart("Water Leaks","300"));
