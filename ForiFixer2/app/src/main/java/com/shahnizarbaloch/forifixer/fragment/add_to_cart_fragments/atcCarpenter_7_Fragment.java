...
public class atcCarpenter_7_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Window Glass Fix","starting from Rs. 50 sq/ft","50"));
        arrayList.add(new AddToCart("Window Installation Sliding","starting from Rs. 150 sq/ft","150"));
        arrayList.add(new AddToCart("Wooden Window Installation","starting from Rs. 120 sq/ft","120"));
