...
public class atcCarpenter_1_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Bed Dismantle","starting from Rs. 500","500"));
        arrayList.add(new AddToCart("Bed Repair","starting from Rs. 600","600"));
