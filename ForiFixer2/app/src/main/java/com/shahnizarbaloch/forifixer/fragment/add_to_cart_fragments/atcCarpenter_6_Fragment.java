...
public class atcCarpenter_6_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Furniture Polish-Varnishing","starting from Rs. 1000","1000"));
        arrayList.add(new AddToCart("Laquer Polish","","1"));
