package com.shahnizarbaloch.forifixer.adapter.add_to_cart;
...
public class ItemRecyclerView extends RecyclerView.Adapter<ItemRecyclerView.MyViewHolder> {
    ...
    public ItemRecyclerView(Context context, ArrayList<AddToCart> arrayList){
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int i) {
       ...
       myViewHolder.SubHeading.setText(obj.getSubHeading());
        if(myViewHolder.SubHeading.getText().toString().isEmpty()){
            myViewHolder.SubHeading.setVisibility(View.GONE);
        }
