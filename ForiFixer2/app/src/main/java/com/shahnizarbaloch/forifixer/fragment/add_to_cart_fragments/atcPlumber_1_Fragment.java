...
public class atcPlumber_1_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Electric Geyser Installation without Piping","1500"));
        arrayList.add(new AddToCart("Geyser Burner Replacement","500"));
        arrayList.add(new AddToCart("Geyser Installation","upto 25 ft piping","1500"));
        arrayList.add(new AddToCart("Geyser Pilot Work","500"));
        arrayList.add(new AddToCart("Geyser Service","750"));
        arrayList.add(new AddToCart("Geyser Thermostat Change","800"));
