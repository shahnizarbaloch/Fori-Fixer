...
public class atcPlumber_4_Fragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.rv_add_to_cart);
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Bath Tub Installation","3000"));
        arrayList.add(new AddToCart("Bathroom Accessory Set Installation","8 / 10 Piece Set Installation (Towel Rack + TOilet ROll + Soap Holder etc)","1000"));
        arrayList.add(new AddToCart("Commode Installation","2000"));
        arrayList.add(new AddToCart("Complete New bathroom set change","10000"));
        arrayList.add(new AddToCart("Flush Button & Lever Change / New","600"));
        arrayList.add(new AddToCart("Flush Tank","600"));
        arrayList.add(new AddToCart("Muslim Shower Replacement/Repair","600"));
        arrayList.add(new AddToCart("Removal of WC and Commode Installation","2750"));
        arrayList.add(new AddToCart("Shower Set Change with New","2500"));
        arrayList.add(new AddToCart("Toilet Seat Fixing","300"));
