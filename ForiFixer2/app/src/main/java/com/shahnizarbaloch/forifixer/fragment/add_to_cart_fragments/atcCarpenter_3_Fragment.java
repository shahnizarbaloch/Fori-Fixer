...
public class atcCarpenter_3_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Door Catcher Magnet","","300"));
        arrayList.add(new AddToCart("Door Chatakni","","300"));
        arrayList.add(new AddToCart("Door Glass Fix","","50"));
        arrayList.add(new AddToCart("Door Handle and Lock Replacement","","600"));
        arrayList.add(new AddToCart("Door Installation Sliding","","120"));
        arrayList.add(new AddToCart("Door Kundi/Latches Replacement","","500"));
        arrayList.add(new AddToCart("Door Chokhat Repair","","500"));
        arrayList.add(new AddToCart("Door Stopper","","500"));
        arrayList.add(new AddToCart("Wooden Door Installation with Lock","","500"));
