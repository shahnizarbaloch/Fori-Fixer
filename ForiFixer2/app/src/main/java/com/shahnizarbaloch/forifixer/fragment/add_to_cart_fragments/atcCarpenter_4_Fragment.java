...
public class atcCarpenter_4_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Drawer Channel Replacement","","500"));
        arrayList.add(new AddToCart("Drawer Lock Change","starting from Rs. 250","250"));
