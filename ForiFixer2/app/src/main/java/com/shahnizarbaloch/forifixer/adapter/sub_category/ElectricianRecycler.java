...
import com.shahnizarbaloch.forifixer.fragment.add_to_cart_fragments.atcElectrician_1_Fragment;
import com.shahnizarbaloch.forifixer.fragment.add_to_cart_fragments.atcElectrician_2_Fragment;
import com.shahnizarbaloch.forifixer.fragment.add_to_cart_fragments.atcElectrician_3_Fragment;
import com.shahnizarbaloch.forifixer.model.Category;

import java.util.ArrayList;

public class ElectricianRecycler extends RecyclerView.Adapter<ElectricianRecycler.MyViewHolder> {

    private ArrayList<Category> arrayList;
    private Context context;

    public ElectricianRecycler(ArrayList<Category> arrayList, Context context){
            ...
            public void onClick(View v) {
                switch (myViewHolder.getAdapterPosition()){
                    case 0:
                        ...
                        fragmentTransaction.replace(R.id.container_switcher,new atcElectrician_1_Fragment(),"");
                        fragmentTransaction.addToBackStack(null).commit();
                        break;
                    case 1:
                        fragmentTransaction.setCustomAnimations(R.anim.enter_from_right,R.anim.exit_to_right,R.anim.enter_from_right,R.anim.exit_to_right);
                        fragmentTransaction.replace(R.id.container_switcher,new atcElectrician_2_Fragment(),"");
                        fragmentTransaction.addToBackStack(null).commit();
                        break;
                    case 2:
                        fragmentTransaction.setCustomAnimations(R.anim.enter_from_right,R.anim.exit_to_right,R.anim.enter_from_right,R.anim.exit_to_right);
                        fragmentTransaction.replace(R.id.container_switcher,new atcElectrician_3_Fragment(),"");
                        fragmentTransaction.addToBackStack(null).commit();
                        break;
