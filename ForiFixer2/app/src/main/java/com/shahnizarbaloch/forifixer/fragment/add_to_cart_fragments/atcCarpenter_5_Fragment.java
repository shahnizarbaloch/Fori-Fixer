...
public class atcCarpenter_5_Fragment extends Fragment {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        arrayList.add(new AddToCart("Art Work or Mirror Installation","per support Rs.200","200"));
        arrayList.add(new AddToCart("Curtain Rod Installation","","300"));
        arrayList.add(new AddToCart("Mosquito netting","starting from Rs.80 sq/ft","80"));
        arrayList.add(new AddToCart("Shelf Installation","","600"));
